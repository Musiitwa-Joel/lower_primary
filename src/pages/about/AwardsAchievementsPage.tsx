...
const AwardsAchievementsPage: React.FC<AwardsAchievementsPageProps> = ({
  theme,
  toggleTheme,
}) => {
  ...
  const achievements: Achievement[] = [
    {
      ...
      description:
        "Recognized as the top-performing secondary school in Uganda for outstanding academic results and innovative teaching methods.",
      category: "academic",
      year: 2023,
      level: "national",
      ...
      impact:
        "Established our reputation as a leading educational institution and attracted top students from across the country",
      participants: [
        "All teaching staff",
    ...
    },
    {
      ...
      description:
        "Our students won first place in the prestigious East Africa Mathematics Olympiad, competing against schools from 6 countries.",
      category: "academic",
      year: 2023,
      level: "international",
      ...
      impact:
        "Showcased our mathematics program excellence on the international stage",
      participants: [
        "Sarah Nakato (S6)",
        "David Mukasa (S5)",
        "Grace Namuli (S4)",
    ...
    },
    {
      ...
      description:
        "Recognized for pioneering the integration of AI and digital learning platforms in secondary education across Uganda.",
      category: "innovation",
      year: 2023,
      level: "national",
      ...
      impact:
        "Led to partnerships with international EdTech companies and government adoption of our digital learning model",
    ...
    },
    {
      ...
      description:
        "Our football team won the Central Region Secondary Schools Football Championship, remaining undefeated throughout the tournament.",
      category: "sports",
      year: 2023,
      level: "regional",
      ...
      impact:
        "Boosted school spirit and attracted talented athletes to our sports programs",
      participants: [
        "School football team",
        "Coach Michael Ssebunya",
        "Sports department",
      ],
      recognitionType: "trophy",
    },
    {
      ...
      description:
        "Honored for outstanding community service initiatives that have positively impacted over 5,000 people in surrounding communities.",
      category: "community",
      year: 2022,
      level: "national",
      ...
      impact:
        "Strengthened community relationships and established sustainable outreach programs",
      participants: [
        "Student council",
    ...
    },
    {
      ...
      description:
        "Recognized as the leading school in environmental conservation efforts, including tree planting, waste management, and renewable energy adoption.",
      category: "community",
      year: 2022,
      level: "national",
      ...
      impact:
        "Inspired other schools to adopt sustainable practices and reduced our carbon footprint by 40%",
    ...
    },
    {
      ...
      description:
        "Awarded for our comprehensive student leadership development program that has produced leaders in various fields across Uganda.",
      category: "leadership",
      year: 2022,
      level: "national",
      ...
      impact:
        "Our alumni now hold leadership positions in government, business, and civil society",
    ...
    },
    {
      ...
      description:
        "Recognized for establishing successful partnerships with schools in 5 countries, facilitating student and teacher exchanges.",
      ...
      impact:
        "Provided global exposure to our students and enhanced cultural understanding",
      participants: [
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Celebrating our journey of excellence through recognition, awards,
              and achievements that reflect our commitment to quality education
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {achievement.awardedBy.length > 20
                          ? `${achievement.awardedBy.substring(0, 20)}...`
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {achievement.participants
                          ? achievement.participants.length
                          : "Multiple"}
                      </span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      >
                        {selectedAchievement.recognitionType}
                      </span>
                    </div>
                  </div>
                </div>
