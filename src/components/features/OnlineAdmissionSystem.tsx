...
const OnlineAdmissionSystem: React.FC<OnlineAdmissionSystemProps> = ({
  theme,
}) => {
  ...
  const handleFileUpload = (
    field: keyof ApplicationData["documents"],
    file: File
  ) => {
    setApplicationData((prev) => ({
      ...prev,
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Thank you for applying to {schoolConfig.name}. Your application
              has been received.
            </p>
            <div
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    If shortlisted, you'll receive an interview invitation via
                    email
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  handleInputChange("studentInfo", "firstName", e.target.value)
                }
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("studentInfo", "lastName", e.target.value)
                }
                className={`px-4 py-3 rounded-lg border ${
                  theme === "dark"
                    ? "bg-white/5 border-white/20 text-white placeholder-white/50"
              ...
              <select
                ...
                onChange={(e) =>
                  handleInputChange("studentInfo", "gender", e.target.value)
                }
                className={`px-4 py-3 rounded-lg border ${
                  theme === "dark"
                    ? "bg-white/5 border-white/20 text-white"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  handleInputChange("parentInfo", "fatherName", e.target.value)
                }
                className={`px-4 py-3 rounded-lg border ${
                  theme === "dark"
                    ? "bg-white/5 border-white/20 text-white placeholder-white/50"
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (file) {
                        handleFileUpload(
                          doc.key as keyof ApplicationData["documents"],
                          file
                        );
                      }
                    }}
            ...
            >
              <div className="space-y-4">
                <div>
                  ...
                  >
                    Student: {applicationData.studentInfo.firstName}{" "}
                    {applicationData.studentInfo.lastName}
                  </h5>
                  <p
                    className={`text-sm ${
                      theme === "dark" ? "text-white/70" : "text-black/70"
