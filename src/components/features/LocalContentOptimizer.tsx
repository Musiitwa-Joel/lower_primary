          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                >
                  Deep understanding of {schoolConfig.address.city}'s
                  educational needs and cultural values
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                >
                  ...
                  {schoolConfig.address.country}'s Ministry of Education
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                >
                  Expanding our positive influence across{" "}
                  {schoolConfig.address.state} region
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                >
                  ...
                  {schoolConfig.address.city} with transport services
                </div>
              </div>
            </div>
          </div>
