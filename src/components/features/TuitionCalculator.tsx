...
const TuitionCalculator: React.FC<TuitionCalculatorProps> = ({ schoolConfig, theme }) => {
  ...
  const calculateTotal = () => {
    ...
    for (const [gradeRange, fees] of Object.entries(schoolConfig.tuition.grades)) {
      if (gradeRange.includes(selectedGrade) || selectedGrade.includes(gradeRange.split('-')[0])) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        {/* Grade Selection */}
        <div>
          <label className={`block text-sm font-medium ${theme === 'dark' ? 'text-white/70' : 'text-black/70'} mb-3`}>
            Select Grade Level
          </label>
        ...
        <div>
          ...
          <div className="space-y-3">
            {Object.entries(schoolConfig.tuition.additionalFees).map(([service, cost]) => (
              <label key={service} className="flex items-center cursor-pointer">
                ...
                />
                <span className={`ml-3 flex-1 ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
                  {service}
                </span>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className={`text-sm ${theme === 'dark' ? 'text-white/70' : 'text-black/70'}`}>
                  {selectedGrade ? `${selectedGrade} - ${boardingType}` : 'Select grade and type'}
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg ${
                ...
                <div className="font-medium text-primary-500 mb-2">Annual Payment</div>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <div className="font-medium text-primary-500 mb-2">Termly Payment</div>
                <div className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <div className="font-medium text-primary-500 mb-2">Monthly Payment</div>
                <div className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
