...
const Dashboard = () => {
  return (
    <section id="dashboard" className="section-padding bg-[var(--dark-bg)] relative">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-[var(--dark-bg)] via-[var(--dark-bg)]/95 to-[var(--dark-bg)]"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="relative">
          <div className="absolute -inset-x-20 -inset-y-20 bg-gradient-to-r from-[var(--primary)]/30 via-[var(--primary-light)]/30 to-[var(--primary-light)]/20 blur-3xl opacity-20 rounded-[3rem]"></div>
