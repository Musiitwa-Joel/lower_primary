...
export const useLocalSEO = ({
  ...
  return {
    generateLocalTitle: (title: string) => `${title} | ${schoolConfig.name} - ${schoolConfig.address.city}, ${schoolConfig.address.country}`,
    generateLocalDescription: (description: string) => `${description} Located in ${schoolConfig.address.city}, ${schoolConfig.address.country}. Contact us at ${schoolConfig.phone.primary}.`,
